...
# TODO: init script should be dynamic - when running this script the user should be prompted for the vars, or they can be passed through as args
unit='logging'
line_num='6'
minutes='1'
exec_filepath='/root/logging.sh'
...
sudo cp $project_root/svc_job_scripts/$unit.sh $exec_filepath
